...
export default function BottomNavigator({ state, descriptors, navigation }) {
  ...
  // Tentukan warna background berdasarkan nama rute aktif
  const activeRouteName = state.routes[state.index].name;
  const backgroundColor = activeRouteName === 'Account' ? colors.white : colors.primary;
          ...
          <TouchableOpacity
            ...
            <View
              ...
              <View
                ...
                <Icon type='ionicon' name={iconName} size={30} color={isFocused ? colors.background : '#C2ECFB'} />
                <Text style={{
                  marginTop: 4,
